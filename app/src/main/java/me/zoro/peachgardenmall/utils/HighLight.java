...
public class HighLight {
    ...
    public HighLight addDivHighLight(View view, int decorLayoutId, OnPosCallback onPosCallback, MyShape shape) {
        ViewGroup parent = (ViewGroup) mAnchor;
        RectF rect = new RectF(viewUtils.getDivLocationInView(parent, view));
        ViewPosInfo viewPosInfo = new ViewPosInfo();
        viewPosInfo.layoutId = decorLayoutId;
        viewPosInfo.rectF = rect;
        viewPosInfo.view = view;
